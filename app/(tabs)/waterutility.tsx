...
const WaterUtilityScreen = () => {
  ...
  const providers: Provider[] = [
    { id: 'angat', name: 'Angat Water District', logo: require('../../assets/images/angatwater.jpg') }, 
    { id: 'basic', name: 'Basic Water Enterprises, Inc', logo: require('../../assets/images/basicwater.jpg') },
    { id: 'genwater', name: 'General Luna Water System Inc', logo: require('../../assets/images/genwater.jpg') }, 
    { id: 'manila', name: 'Manila Water', logo: require('../../assets/images/manilawater.jpg') }, 
    { id: 'maynilad', name: 'Maynilad', logo: require('../../assets/images/maynilad.jpg') }, 
    { id: 'prime', name: 'PrimeWater', logo: require('../../assets/images/primewater.jpg') },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Water Utilities</Text>
        <View style={{ width: 24 }} />
      </View>
