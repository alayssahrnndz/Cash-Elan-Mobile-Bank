...
const TransportationScreen = () => {
  ...
  const providers: Provider[] = [
    { id: 'beep', name: 'Beep™', logo: require('../../assets/images/beep.jpg') },
    { id: 'cebupac', name: 'Cebu Pacific', logo: require('../../assets/images/cebpac.png') },
    { id: 'autosweep', name: 'Autosweep RFID', logo: require('../../assets/images/autosweep.jpg') },
    { id: 'easytrip', name: 'EasyTrip RFID', logo: require('../../assets/images/easytrip.jpg') },
    { id: 'airasia', name: 'AirAsia', logo: require('../../assets/images/airasia.png') },
    { id: 'philairlines', name: 'Philippine Airlines', logo: require('../../assets/images/philair.jpg') },
  ];
