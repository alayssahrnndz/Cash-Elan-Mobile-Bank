...
const CreditCardsScreen = () => {
  ...
  const providers: Provider[] = [
    { id: 'aub', name: 'AUB Credit Cards', logo: require('../../assets/images/aub.png') },
    { id: 'bankofcommerce', name: 'Bank of Commerce', logo: require('../../assets/images/bankofcommerce.png') },
    { id: 'bpi', name: 'BPI Credit Card', logo: require('../../assets/images/bpi.png') },
    { id: 'bdo', name: 'BDO Amex', logo: require('../../assets/images/bdo.png') },
    { id: 'chinabank', name: 'Chinabank Credit Card', logo: require('../../assets/images/chinabank.jpg') },
    { id: 'eastwest', name: 'Eastwest Bank', logo: require('../../assets/images/eastwest.jpg') },
    { id: 'unionbank', name: 'Unionbank of the Philippines', logo: require('../../assets/images/unionbank.jpg') },
  ];
