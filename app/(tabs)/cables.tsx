...
const TvCableBillsScreen = () => {
  ...
  const providers: Provider[] = [
    { id: 'cabletelink', name: 'Cablelink', logo: require('../../assets/images/cablelink.jpg') },
    { id: 'cignal', name: 'Cignal', logo: require('../../assets/images/cignaltv.png') },
    { id: 'gsat', name: 'G Sat', logo: require('../../assets/images/gsat.jpg') },
    { id: 'planetcable', name: 'Planet Cable', logo: require('../../assets/images/planetcable.jpg') },
    { id: 'royalcable', name: 'Royal Cable', logo: require('../../assets/images/royalcable.jpg') },
    { id: 'skycable', name: 'SkyCable', logo: require('../../assets/images/skycable.jpg') },
  ];
