...
const InternetScreen = () => {
  ...
  const providers: Provider[] = [
    { id: 'dito', name: 'DITO Telecommunity', logo: require('../../assets/images/dito.jpg') },
    { id: 'converge', name: 'Converge', logo: require('../../assets/images/converge.jpg') },
    { id: 'globe', name: 'Globe Telecom', logo: require('../../assets/images/globe.png') },
    { id: 'pldt', name: 'PLDT Home', logo: require('../../assets/images/pldt.jpg') },
    { id: 'skyfiber', name: 'Sky Fiber', logo: require('../../assets/images/skyfiber.jpg') },
    { id: 'redfiber', name: 'Red Fiber', logo: require('../../assets/images/redfiber.jpg') },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Internet Providers</Text>
        <View style={{ width: 24 }} />
      </View>
